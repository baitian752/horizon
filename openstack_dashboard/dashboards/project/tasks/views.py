...
from openstack_dashboard.dashboards.project.tasks \
...
class IndexView(tables.PagedTableMixin, tables.DataTableView):
    ...
    def _get_flavors(self):
        # Gather our flavors to correlate our tasks to them
        try:
    ...
    def _get_images(self):
        # Gather our images to correlate our tasks to them
        try:
    ...
    def get_data(self):
        ...
        # Loop through tasks to get flavor info.
        for instance in instances:
            # instance.__setattr__('task_name', 'test')
...
class UpdateView(workflows.WorkflowView):
    ...
    success_url = reverse_lazy("horizon:project:tasks:index")
...
class RebuildView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/rebuild.html'
    success_url = reverse_lazy('horizon:project:tasks:index')
...
class DecryptPasswordView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/decryptpassword.html'
    success_url = reverse_lazy('horizon:project:tasks:index')
...
class DisassociateView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/disassociate.html'
    success_url = reverse_lazy('horizon:project:tasks:index')
...
class DetailView(tabs.TabView):
    ...
    redirect_url = 'horizon:project:tasks:index'
...
class AttachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/attach_interface.html'
    ...
    def get_initial(self):
        ...
        submit_url = "horizon:project:tasks:attach_interface"
...
class AttachVolumeView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/attach_volume.html'
    ...
    def get_initial(self):
        args = {'instance_id': self.kwargs['instance_id']}
        submit_url = "horizon:project:tasks:attach_volume"
        self.submit_url = reverse(submit_url, kwargs=args)
        try:
...
class DetachVolumeView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/detach_volume.html'
    ...
    def get_initial(self):
        args = {'instance_id': self.kwargs['instance_id']}
        submit_url = "horizon:project:tasks:detach_volume"
        self.submit_url = reverse(submit_url, kwargs=args)
        return {"instance_id": self.kwargs["instance_id"]}
...
class DetachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/detach_interface.html'
    ...
    def get_initial(self):
        args = {"instance_id": self.kwargs["instance_id"]}
        submit_url = "horizon:project:tasks:detach_interface"
        self.submit_url = reverse(submit_url, kwargs=args)
        return args
...
class UpdatePortView(port_views.UpdateView):
    ...
    failure_url = 'horizon:project:tasks:detail'
...
class RescueView(forms.ModalFormView):
    ...
    template_name = 'project/tasks/rescue.html'
    submit_label = _("Confirm")
    submit_url = "horizon:project:tasks:rescue"
    success_url = reverse_lazy('horizon:project:tasks:index')
