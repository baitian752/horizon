...
from openstack_dashboard.dashboards.project.tasks import interfaces_tables


class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("project/tasks/"
...
class LogTab(tabs.Tab):
    name = _("Log")
    slug = "log"
    template_name = "project/tasks/_detail_log.html"
    preload = False
...
class ConsoleTab(tabs.Tab):
    name = _("Console")
    slug = "console"
    template_name = "project/tasks/_detail_console.html"
    preload = False
    ...
    def get_context_data(self, request):
        ...
        try:
            ...
            if console_type == "SERIAL":
                console_url = reverse('horizon:project:tasks:serial',
                                      args=[instance.id])
...
class AuditTab(tabs.TableTab):
    ...
    template_name = "project/tasks/_detail_audit.html"
    preload = False
