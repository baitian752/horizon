...
from openstack_dashboard.dashboards.project.tasks import console
from openstack_dashboard.dashboards.project.tasks import tables
from openstack_dashboard.dashboards.project.tasks import tabs
from openstack_dashboard.dashboards.project.tasks import workflows
...
INDEX_URL = reverse('horizon:project:tasks:index')
...
class InstanceTableTests(InstanceTestBase, InstanceTableTestMixin):
    ...
    def test_suspend_instance(self):
        ...
        url = get_url_with_pagination(
            self.request, 'next', 'prev', 'horizon:project:tasks:index')
    ...
    def test_suspend_instance_if_placed_on_2nd_page(self):
        ...
        url = "?".join([reverse('horizon:project:tasks:index'),
                        params])
...
class InstanceDetailTests(InstanceTestBase):
    ...
    def _get_instance_details(self, server, qs=None,
        ...
        url = reverse('horizon:project:tasks:detail', args=[server.id])
        if qs:
            url += qs
    ...
    def test_instance_details_console_tab(self):
        ...
        self.assertTemplateUsed(res,
                                'project/tasks/_detail_console.html')
    ...
    def test_instance_details_exception(self):
        ...
        url = reverse('horizon:project:tasks:detail',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_details_unauthorized(self):
        ...
        url = reverse('horizon:admin:tasks:detail',
                      args=[server.id])
    ...
    def test_instance_details_flavor_not_found(self):
        ...
        self.assertTemplateUsed(res,
                                'project/tasks/_detail_overview.html')
    ...
    def test_instance_log(self):
        ...
        url = reverse('horizon:project:tasks:console',
                      args=[server.id])
        tg = tabs.InstanceDetailTabs(self.request, instance=server)
    ...
    def test_instance_auto_console(self):
        ...
        url = reverse('horizon:project:tasks:auto_console',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_vnc_error(self):
        ...
        url = reverse('horizon:project:tasks:vnc',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_spice(self):
        ...
        url = reverse('horizon:project:tasks:spice',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def test_instance_rdp(self):
        ...
        url = reverse('horizon:project:tasks:rdp',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
...
class InstanceTests(InstanceTestBase):
    ...
    def _test_instances_index_retrieve_password_action(self):
        ...
        url = reverse('horizon:project:tasks:index')
        res = self.client.get(url)
    ...
    def test_decrypt_instance_password(self):
        ...
        url = reverse('horizon:project:tasks:decryptpassword',
                      args=[server.id,
                            server.key_name])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'project/tasks/decryptpassword.html')
    ...
    def test_instance_update_get(self):
        ...
        url = reverse('horizon:project:tasks:update', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_update_get_server_get_exception(self):
        ...
        url = reverse('horizon:project:tasks:update',
                      args=[server.id])
        res = self.client.get(url)
...
class InstanceLaunchInstanceTests(InstanceTestBase,
    ...
    def test_launch_instance_get(self,
        ...
        url = reverse('horizon:project:tasks:launch')
        ...
        self.mock_tenant_quota_usages.assert_called_once_with(
            helpers.IsHttpRequest(),
            targets=('tasks', 'cores', 'ram', 'volumes', 'gigabytes'))
    ...
    def test_launch_instance_post(self,
        ...
        self.mock_tenant_quota_usages.assert_called_once_with(
            helpers.IsHttpRequest(),
            targets=('tasks', 'cores', 'ram', 'volumes', ))
        self.assert_mock_multiple_calls_with_same_arguments(
    ...
    def test_launch_button_attributes(self):
        ...
        launch_action = self.getAndAssertTableAction(res, 'tasks',
                                                     'launch-ng')
...
class InstanceTests2(InstanceTestBase, InstanceTableTestMixin):
    ...
    def _test_disassociate_floating_ip(self, is_release):
        ...
        url = reverse('horizon:project:tasks:disassociate',
                      args=[server.id])
    ...
    def test_instance_resize_get(self):
        ...
        url = reverse('horizon:project:tasks:resize', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_resize_get_server_get_exception(self):
        ...
        url = reverse('horizon:project:tasks:resize',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_rebuild_instance_get(self, expect_password_fields=True):
        ...
        url = reverse('horizon:project:tasks:rebuild', args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'project/tasks/rebuild.html')
    ...
    def _instance_rebuild_post(self, server_id, image_id,
        ...
        url = reverse('horizon:project:tasks:rebuild',
                      args=[server_id])
    ...
    def test_index_form_action_with_pagination(self):
        ...
        params = "=".join([tables.InstancesTable._meta.pagination_param,
                           servers[page_size - 1].id])
        next_page_url = "?".join([reverse('horizon:project:tasks:index'),
                                  params])
    ...
    def _server_rescue_post(self, server_id, image_id,
        ...
        url = reverse('horizon:project:tasks:rescue',
                      args=[server_id])
        return self.client.post(url, form_data)
...
class ConsoleManagerTests(helpers.ResetImageAPIVersionMixin, helpers.TestCase):
    ...
    def test_interface_attach_get(self):
        ...
        url = reverse('horizon:project:tasks:attach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'project/tasks/attach_interface.html')
    ...
    def test_volume_attach_get(self):
        ...
        url = reverse('horizon:project:tasks:attach_volume',
                      args=[server.id])
        ...
        self.assertTemplateUsed(res,
                                'project/tasks/attach_volume.html')
    ...
    def test_volume_detach_get(self):
        ...
        url = reverse('horizon:project:tasks:detach_volume',
                      args=[server.id])
        ...
        self.assertEqual(res.status_code, 200)
        self.assertTemplateUsed(res,
                                'project/tasks/detach_volume.html')
        self.mock_instance_volumes_list.assert_called_once_with(
            helpers.IsHttpRequest(), server.id)
    ...
    def test_interface_detach_get(self):
        ...
        url = reverse('horizon:project:tasks:detach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'project/tasks/detach_interface.html')
