...
INDEX_URL = "horizon:projects:tasks:index"
ADD_USER_URL = "horizon:projects:tasks:create_user"
...
class UpdateInstanceSecurityGroupsAction(sg_base.BaseSecurityGroupsAction):
    ...
    class Meta(object):
        ...
        help_text_template = 'project/tasks/_edit_security_group_help.html'
...
class AdminUpdateInstance(UpdateInstance):
    success_url = "horizon:admin:tasks:index"
    default_steps = (UpdateInstanceInfo,)
