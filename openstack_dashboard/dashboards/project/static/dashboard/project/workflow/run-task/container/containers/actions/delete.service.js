...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.delete.service
   * @Description
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.delete.service', deleteService);
