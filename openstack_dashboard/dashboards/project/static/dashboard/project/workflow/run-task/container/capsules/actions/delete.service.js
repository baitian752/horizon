...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.capsules.actions.delete.service
   * @Description
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.capsules.actions.delete.service', deleteService);
  ...
  deleteService.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.capsules.events'
  ];
