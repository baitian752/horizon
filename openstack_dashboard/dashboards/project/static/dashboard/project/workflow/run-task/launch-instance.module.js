...
(function () {
  ...
  angular
    ...
    /**
     * @name horizon.dashboard.project.workflow.run-task.boot-source-types
     * @description Boot source types
     */
    .constant('horizon.dashboard.project.workflow.run-task.boot-source-types', {
      IMAGE: 'image',
    ...
    .constant('horizon.dashboard.project.workflow.run-task.non_bootable_image_types',
      ['aki', 'ari'])

    /**
     * @name horizon.dashboard.project.workflow.run-task.step-policy
   ...
   * @description Base path for the run-task code
