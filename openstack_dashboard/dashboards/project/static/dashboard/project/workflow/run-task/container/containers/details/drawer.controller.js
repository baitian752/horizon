...
(function() {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.project.workflow.run-task.container.containers.DrawerController
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.DrawerController', controller);
