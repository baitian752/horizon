...
(function() {
  ...
  /**
   * @ngdoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.images.create.service
   * @description
   * Service for the pull image modal
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.images.actions')
    .factory('horizon.dashboard.project.workflow.run-task.container.images.actions.create.service', createImageService);

  createImageService.$inject = [
    'horizon.app.core.openstack-service-api.policy',
    'horizon.app.core.openstack-service-api.zun',
    'horizon.dashboard.project.workflow.run-task.container.images.actions.workflow',
