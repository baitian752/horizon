...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.refresh.service
   * @Description
   * refresh container.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.refresh.service', refreshService);
