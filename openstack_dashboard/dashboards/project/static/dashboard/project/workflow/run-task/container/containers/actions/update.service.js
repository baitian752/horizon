...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.project.workflow.run-task.container.containers.update.service
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.update.service', updateService);
  ...
  updateService.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.containers.workflow',
