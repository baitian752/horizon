...
(function () {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.project.workflow.run-task.container.containers.manage-security-groups
   * @description
   * Controller for the Manage Security Groups dialog.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.manage-security-groups',
  ...
  ManageSecurityGroupsController.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.containers.manage-security-groups.delete.service',
