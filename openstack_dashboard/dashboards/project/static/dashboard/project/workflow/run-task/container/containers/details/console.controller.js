...
(function() {
  ...
  angular
    ...
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.ConsoleController', controller);

  controller.$inject = [
    '$scope',
    'horizon.dashboard.project.workflow.run-task.container.webRoot'
  ];
