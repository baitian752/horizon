...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.project.workflow.run-task.container.containers.create.service
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.create.service', createService);
