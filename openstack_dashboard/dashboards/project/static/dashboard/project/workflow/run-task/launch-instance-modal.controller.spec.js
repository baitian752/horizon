...
(function () {
  ...
  describe('RunTaskModalController tests', function() {
    ...
    beforeEach(inject(function($controller) {
      ctrl = $controller('RunTaskModalController');
    }));
    ...
    it('defines openRunTaskWizard', function() {
      expect(ctrl.openRunTaskWizard).toBeDefined();
    });

    describe('openRunTaskWizard function tests', function() {
      var func, launchContext;

      beforeEach(function() {
        func = ctrl.openRunTaskWizard;
        launchContext = {};
      });
