...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.start.service
   * @Description
   * Start container.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.start.service', startService);
