...
(function() {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.project.workflow.run-task.container.containers.workflow.scheduler-hints
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.workflow.scheduler-hints',
