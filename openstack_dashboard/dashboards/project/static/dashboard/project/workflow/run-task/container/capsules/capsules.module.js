...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.project.workflow.run-task.container.capsules
   * @ngModule
   * @description
   ...
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.capsules', [
      'ngRoute',
      'horizon.dashboard.project.workflow.run-task.container.capsules.actions',
      'horizon.dashboard.project.workflow.run-task.container.capsules.details'
    ])
    .constant('horizon.dashboard.project.workflow.run-task.container.capsules.events', events())
    .constant('horizon.dashboard.project.workflow.run-task.container.capsules.resourceType', 'OS::Horizon::Project::RunTask::Capsule')
    .run(run)
    .config(config);

  /**
   * @ngdoc constant
   * @name horizon.dashboard.project.workflow.run-task.container.capsules.events
   * @description A list of events used by Capsules
   * @returns {Object} Event constants
   */
  function events() {
    return {
      CREATE_SUCCESS: 'horizon.dashboard.project.workflow.run-task.container.capsules.CREATE_SUCCESS',
      DELETE_SUCCESS: 'horizon.dashboard.project.workflow.run-task.container.capsules.DELETE_SUCCESS'
    };
  }
  ...
  run.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.capsules.basePath',
    'horizon.dashboard.project.workflow.run-task.container.capsules.resourceType',
    'horizon.dashboard.project.workflow.run-task.container.capsules.service'
  ];
  ...
  function config($provide, $windowProvider, $routeProvider) {
    ...
    $provide.constant('horizon.dashboard.project.workflow.run-task.container.capsules.basePath', path);
