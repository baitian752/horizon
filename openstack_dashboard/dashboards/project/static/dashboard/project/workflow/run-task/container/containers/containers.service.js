...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.service', containersService);
  ...
  function containersService($location, /*detailRoute,*/ zun) {
    ...
    function getDetailsPath(item) {
      var detailsPath = 'http://' + location.host + '/ngdetails/OS::Zun::Container/' + item.id;
