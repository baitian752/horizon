...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.unpause.service
   * @Description
   * unpause container.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.unpause.service', unpauseService);
