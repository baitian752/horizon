...
(function () {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.project.workflow.run-task.container.containers.workflow.networks
   * @description
   * Controller for the Create Container - Networks Step.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.workflow.networks',
      NetworksController);
