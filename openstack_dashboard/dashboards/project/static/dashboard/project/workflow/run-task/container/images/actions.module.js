...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.dashboard.project.workflow.run-task.container.images.actions
   *
   * @description
   * Provides all of the actions for images.
   */
  angular.module('horizon.dashboard.project.workflow.run-task.container.images.actions',
    [
      'horizon.framework',
  ...
  registerImageActions.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.images.actions.create.service',
    'horizon.dashboard.project.workflow.run-task.container.images.actions.delete.service',
