...
(function() {
  ...
  /**
   * @ngdoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.capsules.actions.create.service
   * @description
   * Service for the create capsule modal
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.capsules.actions')
    .factory('horizon.dashboard.project.workflow.run-task.container.capsules.actions.create.service', createCapsuleService);

  createCapsuleService.$inject = [
    'horizon.app.core.openstack-service-api.policy',
    'horizon.app.core.openstack-service-api.zun',
    'horizon.dashboard.project.workflow.run-task.container.capsules.actions.workflow',
