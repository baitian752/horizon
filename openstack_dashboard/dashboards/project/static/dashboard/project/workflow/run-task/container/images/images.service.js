...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.images.service', imagesService);
  ...
  /*
   * @ngdoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.images.service
   *
   * @description
