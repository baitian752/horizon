...
(function () {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.project.workflow.run-task.container.containers.workflow.mounts
   * @description
   * Controller for the Create Container - Mounts Step.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.workflow.mounts',
      MountsController);

  MountsController.$inject = [
    '$scope',
    'horizon.dashboard.project.workflow.run-task.container.containers.workflow.mounts.delete-volume.service',
