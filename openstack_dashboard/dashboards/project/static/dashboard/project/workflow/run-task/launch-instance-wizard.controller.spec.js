...
(function () {
  ...
  describe('RunTaskWizardController tests', function() {
    var ctrl;
    var model = {
    ...
    beforeEach(module(function ($provide) {
      ...
      $provide.value('RunTaskModel', model);
      $provide.value('horizon.dashboard.project.workflow.run-task.workflow',
        { thing: true });
    }));
    beforeEach(inject(function ($controller) {
      spyOn(model, 'initialize');
      ctrl = $controller('RunTaskWizardController', {$scope: scope});
    }));
