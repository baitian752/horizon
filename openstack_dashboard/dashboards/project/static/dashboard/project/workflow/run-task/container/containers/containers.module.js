...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.project.workflow.run-task.container.containers
   * @ngModule
   * @description
  ...
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers', [
      'ngRoute',
      'horizon.dashboard.project.workflow.run-task.container.containers.actions',
      'horizon.dashboard.project.workflow.run-task.container.containers.details'
    ])
    .constant('horizon.dashboard.project.workflow.run-task.container.containers.events', events())
    .constant('horizon.dashboard.project.workflow.run-task.container.containers.validStates', validStates())
    .constant('horizon.dashboard.project.workflow.run-task.container.containers.adminActions', adminActions())
    .constant('horizon.dashboard.project.workflow.run-task.container.containers.resourceType', 'OS::Horizon::Project::RunTask::Container')
    .run(run)
    .config(config);

  /**
   * @ngdoc constant
   * @name horizon.dashboard.project.workflow.run-task.container.containers.events
   * @description A list of events used by Container
   * @returns {Object} Event constants
   */
  function events() {
    return {
      CREATE_SUCCESS: 'horizon.dashboard.project.workflow.run-task.container.containers.CREATE_SUCCESS',
      DELETE_SUCCESS: 'horizon.dashboard.project.workflow.run-task.container.containers.DELETE_SUCCESS'
    };
  }
  ...
  run.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.containers.basePath',
    'horizon.dashboard.project.workflow.run-task.container.containers.resourceType',
    'horizon.dashboard.project.workflow.run-task.container.containers.service'
  ];
  ...
  function containerProperties() {
    return {
      ...
      'image': {label: gettext('Container'), filters: ['noValue'] },
      ...
      'name': {label: gettext('Task Name'), filters: ['noName'] },
  ...
  function config($provide, $windowProvider, $routeProvider) {
    ...
    $provide.constant('horizon.dashboard.project.workflow.run-task.container.containers.basePath', path);
    $routeProvider
