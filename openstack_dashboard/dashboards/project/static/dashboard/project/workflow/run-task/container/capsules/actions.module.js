...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.dashboard.project.workflow.run-task.container.capsules.actions
   *
   * @description
   * Provides all of the actions for capsules.
   */
  angular.module('horizon.dashboard.project.workflow.run-task.container.capsules.actions',
    [
      'horizon.framework',
  ...
  registerCapsuleActions.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.capsules.actions.create.service',
    'horizon.dashboard.project.workflow.run-task.container.capsules.actions.delete.service',
    'horizon.dashboard.project.workflow.run-task.container.capsules.actions.refresh.service',
