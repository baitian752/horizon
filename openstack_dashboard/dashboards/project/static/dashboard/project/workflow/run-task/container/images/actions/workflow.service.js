...
(function() {
  ...
  /**
   * @ngdoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.images.workflow
   * @description
   * Workflow for pulling image
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.images.actions')
    .factory('horizon.dashboard.project.workflow.run-task.container.images.actions.workflow', workflow);
