...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.images.actions.delete.service
   * @Description
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.images.actions.delete.service', deleteService);
  ...
  deleteService.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.images.events'
  ];
