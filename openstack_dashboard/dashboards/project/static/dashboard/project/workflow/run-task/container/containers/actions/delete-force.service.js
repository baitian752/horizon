...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.delete-force.service
   * @Description
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.delete-force.service', deleteForceService);
  ...
  deleteForceService.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.containers.adminActions',
    'horizon.dashboard.project.workflow.run-task.container.containers.resourceType',
    'horizon.dashboard.project.workflow.run-task.container.containers.events',
    'horizon.dashboard.project.workflow.run-task.container.containers.validStates'
  ];
