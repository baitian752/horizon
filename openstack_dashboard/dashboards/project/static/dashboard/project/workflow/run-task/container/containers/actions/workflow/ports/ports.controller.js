...
(function () {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.project.workflow.run-task.container.containers.workflow.ports
   * @description
   * Controller for the Create Container - Ports Step.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .controller('horizon.dashboard.project.workflow.run-task.container.containers.workflow.ports',
      PortsController);
