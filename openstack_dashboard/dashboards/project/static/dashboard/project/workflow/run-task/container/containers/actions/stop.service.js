...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.stop.service
   * @Description
   * Stop container.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.stop.service', stopService);
