...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.hosts.service', hostsService);
  ...
  /*
   * @ngdoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.hosts.service
   *
   * @description
  ...
  function hostsService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Horizon::Project::RunTask::Host/' + item.id;
    }
