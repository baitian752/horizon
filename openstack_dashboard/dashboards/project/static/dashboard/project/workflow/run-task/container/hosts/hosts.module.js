...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.project.workflow.run-task.container.hosts
   * @ngModule
   * @description
   ...
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.hosts', [
      'ngRoute',
      'horizon.dashboard.project.workflow.run-task.container.hosts.details'
    ])
    .constant('horizon.dashboard.project.workflow.run-task.container.hosts.resourceType', 'OS::Horizon::Project::RunTask::Host')
    .run(run)
    .config(config);
  ...
  run.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.hosts.basePath',
    'horizon.dashboard.project.workflow.run-task.container.hosts.resourceType',
    'horizon.dashboard.project.workflow.run-task.container.hosts.service'
  ];
  ...
  function config($provide, $windowProvider, $routeProvider) {
    ...
    $provide.constant('horizon.dashboard.project.workflow.run-task.container.hosts.basePath', path);
