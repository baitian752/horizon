...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.pause.service
   * @Description
   * pause container.
   */
  angular
    .module('horizon.dashboard.project.workflow.run-task.container.containers')
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.pause.service', pauseService);
