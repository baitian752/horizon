...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.containers.delete-stop.service
   * @Description
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.containers.delete-stop.service', deleteStopService);
