...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.dashboard.project.workflow.run-task.container.containers.actions
   *
   * @description
   * Provides all of the actions for containers.
   */
  angular.module('horizon.dashboard.project.workflow.run-task.container.containers.actions',
    [
      'horizon.framework',
  ...
  registerContainerActions.$inject = [
    ...
    'horizon.dashboard.project.workflow.run-task.container.containers.create.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.update.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.delete.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.delete-force.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.delete-stop.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.start.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.stop.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.restart.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.rebuild.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.pause.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.unpause.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.execute.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.kill.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.refresh.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.manage-security-groups.service',
    'horizon.dashboard.project.workflow.run-task.container.containers.resourceType'
  ];
