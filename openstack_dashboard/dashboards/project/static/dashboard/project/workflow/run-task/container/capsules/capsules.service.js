...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.workflow.run-task.container.capsules.service', capsulesService);
  ...
  /*
   * @ngdoc factory
   * @name horizon.dashboard.project.workflow.run-task.container.capsules.service
   *
   * @description
  ...
  function capsulesService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Horizon::Project::RunTask::Capsule/' + item.id;
    }
